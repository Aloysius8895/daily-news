...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--skip-ai", action="store_true", help="Skip OpenAI summarization and use local fallback.")
...
def main() -> None:
    ...
    context = PipelineContext(
        ...
        options=PipelineOptions(skip_ai=args.skip_ai, dry_run=args.dry_run),
    )
